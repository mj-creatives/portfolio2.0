...
const projects = [
  ...
  },
  {
    ...
    image: school,
    source_code_link:
      'https://github.com/FreenyGroup/freenydrivingschool',
  ...
  },
  {
    ...
    image: rapid,
    source_code_link:
      'https://github.com/FreenyGroup/rapidglobalsupplychain',
...
const projects2 = [
  {
    ...
    image: fservices,
    source_code_link:
      'https://github.com/FreenyGroup/FreenyServicesFinal',
  ...
  },
  {
    ...
    image: flogistics,
    source_code_link:
      'https://github.com/FreenyGroup/FreenyLogisticsFinal',
  ...
  },
  {
    ...
    image: group,
    source_code_link:
      'https://github.com/FreenyGroup/FreenyGroupFinal2',
...
const dataprojects = [
  {
    name: 'Cyclistic membership data visualization',
    description:
      'Use R language to consolidate downloaded Divvy data into a single dataframe and conduct an analysis to answer the question: "In what ways do members and casual riders use Divvy bikes differently?"',
    tags: [
      {
        name: 'R',
        color: 'green-text-gradient',
    ...
    image: cycle,
    source_code_link:
      'https://github.com/mj-creatives/google-data-analytics-cyclistic-capstone',
    web_link:
      './dataprojects/google-data-analytics-cyclistic-capstone-josue-v.html',
  },
  {
    name: 'Supermarket sales exploratory data analysis',
    description:
      'The goal is to identify opportunities to increase gross margin percentage and gross income by targeting specific customer segments, product lines, or marketing channels."',
    tags: [
      {
        name: 'Python',
        color: 'green-text-gradient',
    ...
    image: supermarket,
    source_code_link:
      'https://github.com/mj-creatives/EDA-With-Python-and-Pandas-Supermarket',
    web_link:
      './dataprojects/supermarket-sales-eda-josue-valdez.html',
  },
  {
    name: 'Amazon Echo reviews sentiment analysis',
    description:
      'The intent of this project is to build, train, test, and deploy an artificial intelligence model to predict sentiment from real Amazon Echo customer reviews."',
    tags: [
      {
        name: 'Python',
        color: 'green-text-gradient',
    ...
    image: echo,
    source_code_link:
      'https://github.com/mj-creatives/Amazon-Echo-Review-Sentiment-Analysis',
    web_link:
      './dataprojects/amazon-echo-reviews-sentiment-analysis.html',
  },
  {
    name: 'Covid19 global data visualization',
    description:
      'The project is intended to provide insights into the dynamics of COVID-19 and to evaluate the effectiveness of public health interventions and healthcare systems in managing the pandemic"',
    tags: [
      {
        name: 'Python',
        color: 'green-text-gradient',
    ...
    image: covid,
    source_code_link:
      'https://github.com/mj-creatives/COVID19-data-visualization-python',
    web_link:
      './dataprojects/covid19-data-visualization-python-josue-valdez.html',
  },
];
